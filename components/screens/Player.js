...
const img_speaker = require('../../assets/audio/ui_speaker.png');
const img_pause = require('../../assets/audio/pause.png');
const img_play = require('../../assets/audio/play.png');
const img_playjumpleft = require('../../assets/audio/ui_playjumpleft.png');
const img_playjumpright = require('../../assets/audio/ui_playjumpright.png');
            ...
            <View style={{flex:1, justifyContent:'center', backgroundColor:'black'}}>
                ...
                <View style={{flexDirection:'row', justifyContent:'center', marginVertical:15}}>
                    ...
                    <TouchableOpacity onPress={this.pause} style={{marginHorizontal:20}}>
                        <Image source={img_pause} style={{width:30, height:30 , tintColor: "red"}}/>
                    </TouchableOpacity>}
                    {this.state.playState == 'paused' && 
                    <TouchableOpacity onPress={this.play} style={{marginHorizontal:20}}>
                        <Image source={img_play} style={{width:30, height:30 , tintColor: "red" }}/>
                    </TouchableOpacity>}
                ...
                <Text style={{color:'white', alignSelf:'center',justifyContent:"center"}}>{currentTimeString}</Text>
                ...
                {/* <View style={{marginVertical:15, marginHorizontal:15, flexDirection:'row'}}>
                    ...
                    <Slider
                        ...
                        style={{flex:1, alignSelf:'center', marginHorizontal:Platform.select({android:5})}}/>
